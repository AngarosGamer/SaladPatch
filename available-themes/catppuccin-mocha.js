(() => {
    const styleId = 'catppuccin-mocha-theme';
...
#root .css-wsskga:hover {
  ...
  box-shadow: 0 0 24px color-mix(in srgb, var(--salad-accent) 60%, transparent) !important;
...
#root .css-6s4cpm,
#root .css-y12liw {
  box-shadow: 0 0 16px color-mix(in srgb, var(--salad-accent) 40%, transparent) !important;
}
...
#root .css-1pknec1 .css-1tlze2r {
  box-shadow: 0 0 18px color-mix(in srgb, var(--salad-accent) 34%, transparent) !important;
}
...
#root .css-1sws06r {
  ...
  background-color: var(--salad-accent) !important;
  box-shadow: 0 0 16px color-mix(in srgb, var(--salad-accent) 45%, transparent) !important;
...
#root .css-1tlze2r {
  ...
  box-shadow: 0 0 18px color-mix(in srgb, var(--salad-accent) 36%, transparent) !important;
}
...
`;
    ...
    console.log('[theme] Catppuccin Mocha applied');
})();
