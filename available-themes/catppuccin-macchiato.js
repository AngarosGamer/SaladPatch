(() => {
    const styleId = 'catppuccin-macchiato-theme';
...
#root .css-wsskga:hover {
  ...
  box-shadow: 0 0 24px color-mix(in srgb, var(--salad-accent) 38%, transparent) !important;
...
`;
    ...
    console.log('[theme] Catppuccin Macchiato applied');
})();
